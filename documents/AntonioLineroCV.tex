...
\cvitem{\docounter}{ 
  \textbf{Linero, A.R.}, Basak, P.$^{\star}$, Li, Y.$^{\star}$, and Sinha, D. (2020+) Bayesian Survival Tree Ensembles with Submodel Shrinkage. \emph{Submitted.}
}

\cvitem{\docounter}{ 
  Basak, P.$^{\star}$, \textbf{Linero, A.R.}, Sinha, D., and Lipsitz, S.R.
  (2020+) Semiparametric analysis of clustered interval-censored survival data using Soft Bayesian Additive Regression Trees (SBART). \emph{Revision invited by Biometrics.}}
...
\cvitem{\docounter}{ Li, Y.$^{\star}$, \textbf{Linero, A.R.}, and Murray, J.S.
  ...
  Tree Ensembles . \emph{Submitted.} }

\cvitem{\docounter}{
  \textbf{Linero, A.R.} (2020+) Simulation-Based Estimators of Intractable
  Causal Effects. \emph{Revision invited by Biometrics.}
}
...
\cvitem{\textbf{SDS 383D}}{Statistical Modeling II. Spring 2020}
