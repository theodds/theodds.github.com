...
\cvitem{\docounter}{
  \textbf{Linero, A.R.} (2020+) Simulation-Based Estimators of Analytically Intractable
...
\cvitem{\docounter}{ 
  ...
  (2020+) Semiparametric analysis of clustered interval-censored survival data using Soft Bayesian Additive Regression Trees (SBART). \emph{To appear in Biometrics.}}
...
\cvitem{\docounter}{Varbanov, R.$^{\star}$, Shamp, W.$^{\star}$, Chicken, E, \textbf{Linero, A.R.}, Yang, Y. (2020+)
  ...
  \emph{To appear in Journal of Quality Technology.}
}
