...
\cvitem{\docounter}{ 
  ...
  (2020+) Semiparametric analysis of clustered interval-censored survival data using Soft Bayesian Additive Regression Trees (SBART) \emph{Submitted.} }
...
\cvitem{\docounter}{
  Varbanov, R.$^{\star}$, Shamp, W.$^{\star}$, Chicken, E, \textbf{Linero, A.R.}, Yang, Y. (2020+)
