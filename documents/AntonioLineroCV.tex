...
\cvitem{2018--2022}{\emph{The Science of Test: Advanced Test and Evaluation in
    Support of the DOD Test and Evaluation Enterprise} (Participant, PI on Subcontract at UT, PI Eric Chicken). Funded by Department of Defense. Total award
  \$478,000.}{}
...
\cvitem{2016--2018}{\emph{Functional Analysis Tools (FATs)} (Participant, PI Eric Chicken).
...
\cvitem{}{($\star \rightarrow$ expected graduation)}
...
\cvitem{}{
  ...
  Ding Jiang (2021),
  Yinpi Li ($2021^\star$, Co-advisor Debajyoti Sinha),
  Lexi Rene ($2022^\star$, Co-advisor Elizabeth Slate),
  Kaizong Ye ($2022^\star$, Co-advisor Fred Huffer)
}
...
\cvitem{\docounter}{
  \textbf{Linero, A.R.} (2021+) In Nonparametric and High-Dimensional Models, Bayesian Ignorability is an Informative Prior. \emph{Submitted.} 
}

\cvitem{\docounter}{
  Rene, L.$^{\star}$, \textbf{Linero, A.R.}, and Slate, E. (2021+) Causal Mediation and Sensitivity Analysis for Mixed Scale Data. \emph{Submitted.} 
}
...
\cvitem{\docounter}{
  Jiang, D.$^{\star}$, \textbf{Linero, A.R.}, and Zhang, X. (2021+) Envelope Methods for Missing Response Data in Multivariate Linear Models. \emph{Submitted.}
}

\cvitem{\docounter}{
  Wright, S.$^{\star}$, \textbf{Linero, A.R.}, and Chicken, E. (2021+) Bayesian
  Sequential Monitoring of Density Estimates. \emph{Minor Revision at Quality and Reliability Engineering International.}
}
...
\cvitem{\docounter}{ Li, Y.$^{\star}$, \textbf{Linero, A.R.}, and Murray, J.S.
  ...
  Tree Ensembles. \emph{Acceptable after Major Revisions at Journal of the American Statistical Association.} }
...
\cvitem{\docounter}{ 
  \textbf{Linero, A.R.}, Basak, P.$^{\star}$, Li, Y.$^{\star}$, and Sinha, D. (2021) Bayesian Survival Tree Ensembles with Submodel Shrinkage. \emph{Bayesian Analysis}
}


\cvitem{\docounter}{
  \textbf{Linero, A.R.} (2021) Simulation-Based Estimators of Analytically Intractable
  Causal Effects. \emph{Biometrics.}
}


\cvitem{\docounter}{ 
  Basak, P.$^{\star}$, \textbf{Linero, A.R.}, Sinha, D., and Lipsitz, S.R.
  (2021) Semiparametric analysis of clustered interval-censored survival data using Soft Bayesian Additive Regression Trees (SBART). \emph{Biometrics.}}
...
\cventry{6/27/2021}{ISBA}{Advanced Topics in Variable Selection and Model Averaging}{}{}{}
