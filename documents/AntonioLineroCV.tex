...
\cvitem{\docounter}{ 
  \textbf{Linero, A.R.}, Basak, P.$^{\star}$, Li, Y.$^{\star}$, and Sinha, D. (2020+) Bayesian Survival Tree Ensembles with Submodel Shrinkage. \emph{Revision invited by Bayesian Analysis}
}
