...
\cvitem{\docounter}{
  \textbf{Linero, A.R.} (2020+) Simulation-Based Estimators of Intractable
  Causal Effects. \emph{Submitted.}
}

\cvitem{\docounter}{
  Doss, H. and \textbf{Linero, A.R.} (2019+) A Fully-Bayes Approach to Empirical Bayes Inference and Sensitivity Analysis.
  \emph{Submitted.}
}

\cvitem{\docounter}{
  Varbanov, R.$^{\star}$, Shamp, W.$^{\star}$, Chicken, E, \textbf{Linero, A.R.}, Yang, Y. (2019+)
  Computationally Efficient Bayesian Sequential Function Monitoring. 
  \emph{Revision Invited from Journal of Quality Technology.}
}
