...
\cvitem{}{
  ...
  Ding Jiang (2021, Co-advisor Xin Zhang),
  Yinpi Li ($2021$, Co-advisor Debajyoti Sinha),
...
\cvitem{\docounter}{\textbf{Linero, A.R.} Generalized Bayesian Additive Regression Trees: Beyond Conditional Conjugacy. \emph{Submitted}}

\cvitem{\docounter}{\textbf{Linero, A.R.} and Zhang, Q. Mediation Analysis using Bayesian Tree Ensembles. \emph{Minor Revision at Psychological Methods.}}

\cvitem{\docounter}{Orlandi, V., Murray, J., \textbf{Linero, A.R.}, and Volfovsky, A. (2021+) Density Regression with Bayesian Additive Regression Trees. \emph{Submitted}}

\cvitem{\docounter}{\textbf{Linero A. R} and Antonelli, J.L. (2021+) The How and Why of Bayesian Nonparametric Causal Inference. \emph{Submitted.}}
